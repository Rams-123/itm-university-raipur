...
const programsData = {
  programs: [
    // ... (previous 4 programs retained as-is: Mechanical, CSE - Cloud, CSE - Data Science, Mechatronics)
      ...
      semesters: [
        {
          name: "Sem 1",
          courses: [
            "Foundation for Management Courses 1 (MCOB)",
            "Foundation for Management Courses -2 (Business Environment & Principles of Accounting )",
            "Accounting for Managers",
            "Marketing Management",
            "Managerial /Economics (Micro and Macro)",
            "Entrepreneurship-I",
            "Human Resource Management",
            "Application of MS-Office Package for Managers",
        ...
        },
        {
          ...
          courses: [
            ...
            "Supply Chain Management (including Logistic and value chain)",
            "Mercantile Law",
            "Entrepreneurship -II",
            "Operations Management",
            "Advanced MS Excel for Managers",
            "Application of SPSS in Business",
            "SPECIALIZATIONS (FIN/HR/MKT)",
        ...
        },
        {
          name: "Sem 4",
          courses: [
            "Cross Cultural Tour (1 week) National/International",
            "Internship/Capstone Project-IV",
          ],
        },
      ],
    },
      ...
      semesters: [
        {
          name: "Sem 1",
          courses: [
            "Foundation for Management Courses 1 (Management Concepts and Organizational Behaviour)",
            "Foundation for Management  Courses -2 (Business Environment & Principles of Accounting )",
            "Accounting for Managers",
            "Marketing Management",
            ...
            "Production Management",
            "Communication Skills",
            "MS-Office Packages  for Managers",
            "Capstone Project-I",
            "Business Analysis- I",
            "Career Management-I",
        ...
        },
        {
          ...
          courses: [
            ...
            "Industrial Psychology and  HR Analytics",
            "Managerial Communication Skill",
            "Application of SPSS in Business",
            "Capstone Project-3",
            "Business Analysis -3",
            "Career management-III",
            "Urban Economy Exploration",
          ],
        },
        {
          name: "Sem 4",
          courses: [
            "Cross cultural tour National /International",
            "Internship/ Placement Offer/ Appointment Letter",
          ],
        },
      ],
    },
