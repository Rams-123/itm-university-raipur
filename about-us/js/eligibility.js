...
const eligibilityAccordionData = [
  {
    ...
    content: `
      <p class="text-sm md:text-base mb-4">
        To apply for the MBA <i>𝒊Connect</i> program at ITM Vocational University, candidates must have a bachelor’s degree from any UGC-recognized University and at least 50% marks in the qualifying examination (Graduation). Final-year students are also eligible to apply.
      </p>
    `,
  },
  {
    ...
    content: `
        ...
        <ul class="list-decimal pl-5 list-inside">
          ...
          <li><span>Slabs:</span>
            <ul class="list-disc pl-5 list-inside">
              ...
              <li>₹30,000/- (MBA only) till Pt. RSU Graduation results</li>
            </ul>
          </li>
        </ul>
      </div>
      ...
      <div class="flex flex-col gap-2">
        <span class="font-bold">4. Alumni Scholarship</span>
        <ul class="list-decimal pl-5 list-inside">
          <li>MBA: 50% of 1st-year tuition fee</li>
        </ul>
      </div>

      <div class="flex flex-col gap-2">
        <span class="font-bold">5. Sibling Scholarship</span>
        <ul class="list-decimal pl-5 list-inside">
      ...
      <div class="flex flex-col gap-2">
        <span class="font-bold">6. Campus Workshop Scholarship</span>
        <ul class="list-decimal pl-5 list-inside">
      ...
      <div class="flex flex-col gap-2">
        <span class="font-bold">7. Event Scholarship</span>
        <ul class="list-decimal pl-5 list-inside">
      ...
      <div class="flex flex-col gap-2">
        <span class="font-bold">8. Defence Category Scholarship</span>
        <ul class="list-decimal pl-5 list-inside">
      ...
      <div class="flex flex-col gap-2">
        <span class="font-bold">Eligible Services:</span>
        <ul class="list-decimal pl-5 list-inside">
  ...
  },
  {
    ...
    content: `
      ...
      <div class="flex flex-col gap-2">
        ...
        <p>Pay ₹20,000 to reserve your seat.</p>
      </div>
    `,
  },
];
