  ...
  programs: [
    {
      ...
      semesters: [
        ...
        },
        {
          ...
          courses: [
            "Cloud Computing",
            "Theory of Automata & Computing",
            "Operating System",
            "Programming in Python",
            "Software Engineering and Agile & Scrum (Elective)",
            "Compiler Design (Elective)",
            "English Language - II",
            "Financial Literacy/Academic Writing/Professional Image Build/Yoga & Mental Wellness/Creative Arts",
          ],
        },
        ...
        },
        {
          ...
          courses: [
            ...
            "Cloud Scripting Using PaaS (Elective)",
            "Cloud Web Services (Elective)",
            "Blockchain Technology & Its Applications (Elective)",
            "Principles of Virtualization (Elective)",
            "Cyber Security and Digital Forensics (Elective)",
            "ASP.Net (Elective)",
          ],
        },
        {
          ...
          courses: [
            ...
            "Prompt Engineering",
            "Cloud Security & Service Management (Elective)",
            "Internship/Minor Project Reporting",
          ],
        },
        {
          name: "Year 4 - Semester 2",
          courses: ["Major Project Reporting"],
        },
      ],
    },
  ],
